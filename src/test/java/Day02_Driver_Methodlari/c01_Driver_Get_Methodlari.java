...
public class c01_Driver_Get_Methodlari {
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("Girdiğiniz sayfanın title: "+driver.getTitle()); // bize title'i dondurur
        // IT Bootcamp, Distance education method - Wise Quarter Course


        System.out.println("Girdiğiniz sayfanın urlsi: "+driver.getCurrentUrl());// gidilen url'i dondurur
        ...
        Thread.sleep(1000);
        //sayfayı 1000 milisaniye yani 1 sn bekletir.
        driver.close();
        //sayfayı kapatır.
    }
}
